...
|---|---|---|
| E1 | [독립 반복 계약](20-독립반복-실행계약.md), [원래 사전등록](../../../../outputs/reports/yr317_v3_independent_eval/prereg.md), [80건 결과](30-독립반복-최종결과.md), [시드별 표](32-독립시드별-결과표.md), [교착 진단](31-정지-결함-진단.md) | 80건 완료·사전등록 통계 산출(표 3). 시간정책 16/20·교착 제외 15/15 구간 양수, 전체·블록 정책은 재현 안 됨. 교착은 시뮬레이터 결함이며 수정·재실행 전 |
