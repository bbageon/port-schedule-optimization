"""30일 무대 학습 실행 진입점 ([[YR-239]]).
    ...
    PYTHONPATH=src python -m yard_rl.v5.train --seed 9900700 --workers 20
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="yard_rl.v5.train",
    ...
    ap.add_argument("--out", default="outputs/v5/month", help="결과 폴더")
