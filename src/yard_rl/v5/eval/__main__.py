"""30일 무대 판정 실행 진입점 ([[YR-239]]).
    ...
    PYTHONPATH=src python -m yard_rl.v5.eval --seed 9400000 \\
        --ckpt outputs/v5/month/ckpt_028.pt --workers 7
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="yard_rl.v5.eval",
    ...
    ap.add_argument("--out", default="outputs/v5/month-judge")
