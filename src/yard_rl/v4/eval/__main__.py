"""30일 무대 판정 실행 진입점 ([[YR-239]]).
    ...
    PYTHONPATH=src python -m yard_rl.v4.eval --seed 9400000 \\
        --ckpt outputs/v4/month/ckpt_028.pt --workers 7
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="yard_rl.v4.eval",
    ...
    ap.add_argument("--out", default="outputs/v4/month-judge")
