...
#:
#: ★**1.0 으로 바꿨다** ([[YR-311]] · 2026-09-12 · 사전등록 기준 둘 다 통과).
#:   같은 날·같은 시드·같은 순서로 계수 4.0(23회차) 과 1.0(36회차 — 훈련량을 맞춤)을
#:   견줬다. 궤적(부하 7,500 · 처음 규칙을 이긴 회차 이후의 평탄부):
#:
#:                          계수 4.0     계수 1.0
#:       평탄부 평균         +3.61%      +2.24%    ← 나아졌다 (주 기준 ①)
#:       평탄부 표준편차      4.66%       4.20%    ← 줄었다  (주 기준 ②)
#:       한 회차 변동 중앙    5.92%       3.45%    ← −42%
#:       최저점             −3.61%      −5.63%
#:       이긴 회차 비율       5/20        10/31
#:
#:   [[YR-310]] 은 회차를 12 로 고정해 훈련량이 1/4 이 되는 교란이 있었다. 36회차로
#:   맞추자 널뛰기와 성적이 **둘 다** 나아졌다.
#:
#: ⚠️ 그래도 평탄부 평균이 **양수**다 — 규칙 크레인보다 아직 조금 비싸다.
#:    이 계수는 학습을 **안정**시킨 것이지 규칙을 이기게 한 것이 아니다.
FIT_STEPS_PER_SAMPLE = 1.0
