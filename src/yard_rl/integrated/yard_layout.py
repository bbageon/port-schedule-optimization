...
★정본 확정(사용자 결정 2026-08-09, YR-158): 게이트인→장치장 **5분(중심 300초)·명목
30km/h·턴타임 평균 15분**. 이 시간 계약이 정본이고, 아래 좌표·속도(유효 18km/h)는
그 시간을 만드는 **합성 매개변수**다 — 물리 거리 재현이 아니므로 실거리 주장 금지
(30km/h×5분=2.5km 와 좌표 축척이 달라도 실행·상대 비교에 영향 없음).
근거: .claude/docs/strategy-history/2026-08-09-YR-158-주행시간-정본-사용자결정.md
"""
