"""YR-248 1단계 — 본선 여유 배수 재보정. 신호가 살아나는가, 무대가 망가지지 않는가.
    ...
    PYTHONPATH=src python scripts/v5/probe_dmult_recalib.py [일수]
...
def slack_saturation(d: float) -> float:
    ...
    from yard_rl.v5.stage.month import plan_month_vessels
    from yard_rl.v5.world.integrated.terminal_stream import OBS_24H
