"""YR-248 0단계 — 본선 일정 여유(`slack_s`)가 죽은 칸인 **이유**.
    ...
    PYTHONPATH=src python scripts/v5/probe_vessel_slack.py
...
from yard_rl.v5.world.integrated.scenario_gen import (            # noqa: E402
    TerminalGenParams)
from yard_rl.v5.stage.vessels import STREAM_MOVES_PER_H           # noqa: E402
