"""[[YR-300]] — v3 원본과 v4 최적화판이 **같은 슬롯·같은 비트**를 내는지 직접 대조.
    ...
    PYTHONPATH=src python scripts/v4/verify_find_slot.py
...
from yard_rl.v4.world.domain.models import Container as C4            # noqa: E402
from yard_rl.v4.world.integrated.profiles import build_h21_profile as p4  # noqa: E402
from yard_rl.v4.world.sim.stack import YardStacks as S4               # noqa: E402
