...
from yard_rl.v6.reward.krw import truck_wait_krw
from yard_rl.v6.stage.bridge import MarketBridge
from yard_rl.v6.stage.cargo_input import restore_input
from yard_rl.v6.stage.cargo_runtime import CargoBlock, CargoTerminal
from yard_rl.v6.stage.episode import INFO_LEVEL, _rule_policy
from yard_rl.v6.stage.fixed_seed import build_fixed_seed
from yard_rl.v6.stage.month import DayPlan
from yard_rl.v6.stage.orders import V3Announcer, orders_from_schedule
from yard_rl.v6.world.domain.enums import ContainerSize, JobStatus, LoadStatus
from yard_rl.v6.world.domain.models import Container
from yard_rl.v6.world.integrated.multiblock import TransferError
from yard_rl.v6.world.integrated.profiles import build_h21_profile
from yard_rl.v6.world.integrated.terminal_stream import ensure_time_ledger
...
def world(*, full=True, pickup=False, initial_count=None, reserved_moves=0):
    ...
    if reserved_moves:
        from yard_rl.v6.stage.month_engine import inject_vessel
...
def test_capacity_change_does_not_relax_identity_time_or_ledger_checks(invalid):
    from yard_rl.v6.world.integrated.terminal_stream import _job_from_entry
