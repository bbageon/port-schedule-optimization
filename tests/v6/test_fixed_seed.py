...
from yard_rl.v6.stage.fixed_seed import build_fixed_seed, fixed_seed_audit
from yard_rl.v6.stage.month import DayPlan
from yard_rl.v6.stage.seed_bundle import load_seed_bundle, save_seed_bundle
from yard_rl.v6.world.domain.enums import ContainerSize, LoadStatus
...
def test_vessel_source_size_sequence_matches_the_frozen_engine():
    ...
    from yard_rl.v6.world.integrated.events import EventQueue
