...
from yard_rl.v6.schema import Order, defer, relocate
from yard_rl.v6.stage.container_contract import (
    ContainerContractError, audit_container_plan, container_no,
    namespace_initial_inventory, require_container_plan,
)
from yard_rl.v6.stage.month import make_retarget
...
def test_day_prefix_is_also_applied_to_the_produced_container():
    from yard_rl.v6.stage.month import DayPlan, DAY_S, build_month
