...
from yard_rl.v4.stage.month import (COOLDOWN_DAYS, DAY_S, LOAD_WEIGHTS, N_DAYS,
...
from yard_rl.v4.stage.month_engine import MonthTerminal, inject_vessel
from yard_rl.v4.world.integrated.multiblock import MultiBlockTerminal
...
def test_vessel_work_balances_the_yard(sd):
    ...
    """
    from yard_rl.v4.stage.vessels import plan_streams, sample_day_vessels
    from yard_rl.v4.world.integrated.yard_layout import terminal_layout
...
def test_sign_test_matches_published_numbers():
    ...
    """
    from yard_rl.v4.eval.month_judge import sign_test
...
def test_announcer_window_keeps_only_that_stretch():
    ...
    from yard_rl.v4.stage.orders import V3Announcer
...
def test_each_block_stays_near_its_starting_level():
    ...
    """
    from yard_rl.v4.stage.month import MONTH_FILL_RATIO
...
def test_judge_flags_a_silent_rl_arm():
    ...
    """
    from yard_rl.v4.eval import month_judge as MJ
...
def test_eligibility_index_matches_the_old_full_scan():
    ...
    """
    from yard_rl.v4.actors import Buyer, BuyerNet, Market, Seller, SellerNet
    from yard_rl.v4.schema import Stage
    from yard_rl.v4.stage.orders import orders_from_schedule
...
def test_ctx_explore_is_what_branches_read():
    ...
    from yard_rl.v4.stage.episode import _Ctx
...
def test_identity_check_costs_no_extra_world():
    ...
    from yard_rl.v4.stage.rollout import BranchResult, identity_check
