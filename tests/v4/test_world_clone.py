...
def test_v3_imports_nothing_outside_v3():
    ...
    import yard_rl.v4.eval  # noqa: F401
    import yard_rl.v4.stage  # noqa: F401
    import yard_rl.v4.train  # noqa: F401
    ext = sorted(m for m in set(sys.modules) - before
                 if m.startswith("yard_rl.") and not m.startswith("yard_rl.v4"))
