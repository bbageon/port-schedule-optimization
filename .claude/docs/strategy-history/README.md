...
| 2026-07-15 | YR-033 | 사전등록 — 실행 전 동결 | YR-012-c winner's curse 검증: 결정론 재실행·P1(val30)/P2(val90)/P3(smooth) 재선택·fresh test(240k)·val-test Spearman 진단. test 선택 미사용 | [사전등록](2026-07-15-YR-033-checkpoint-selection-prereg.md) |
