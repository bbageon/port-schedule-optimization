...
| 2026-07-18 | YR-063 | **사전등록 완료·실행 대기** | 차분 credit `D_i = C_600s(내 행동) − C_600s(WAIT_i)` (상대 고정·JR rollout 기계 재사용·CTDE 지위) 1-step Q 회귀. G1 = scratch 최초 건강 정책(swa≥0.25), G2 사다리 = vs 퇴화RL/BC/SF_SPT paired | [사전등록](2026-07-18-YR-063-차분귀속-prereg.md) |
