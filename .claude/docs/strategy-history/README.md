...
| 2026-07-18 | YR-062 | **사전등록 완료·실행 대기** | BC(model_IMITATE) warm-start + TD 미세조정 lr {1e-4,3e-4,1e-3} — ep0(BC) 포함 val-best 선택, ε=0.3/√ep. F2 = vs BC·vs SF_SPT paired CI. 알려진 위험(CE 서수 Q 의 TD 재척도화 파국) 사전 명시 | [사전등록](2026-07-18-YR-062-BC미세조정-prereg.md) |
