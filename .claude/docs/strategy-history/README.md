...
| 2026-07-18 | YR-061 | **phase 1 기각(전제 불성립) → phase 2(γ 사다리) 등록** | 미완료 페널티 무발동 — 완료율은 구조적으로 항상 1.0 (4 arm 바이트 동일). 퇴화 실체 = 방치가 아니라 **지연**(대기 3.5배·결정 4.7배). 새 용의자 = **할인 근시**(1h 뒤 비용 ×0.046 vs 비할인 평가) → γ {0.95, 0.99, 0.999, 1.0} 사다리 동결 | [사전등록+결과](2026-07-18-YR-061-미완료페널티-prereg.md) |
