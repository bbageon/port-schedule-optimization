...
> 상태: **done (2026-08-02 — ★공식 기각 1성분·역대 최초 실비용 개선 3/3)**
...
- G0 전판 ✓ · v2 총비용 −3.789/−1.938/−2.209 (**방향 3/3 — 학습 트랙 최초 실비용 개선**)·
  A→O −2.9~−3.7분·짝 승률 27/36. 공식 기각 = REPO 장악 1/36 (기준 0).
- 결함판 29/36 → 1/36: 단위 수리가 지배 요인. 잔존 = 재배치 비중 0.25~0.40.
- 분기: (권고) v4-B 구속적 PREPOSITION → 성공 시 잠금평가. 2900 대역 열람됨.
- [report](../../../outputs/reports/yr140_ppo_unitfix/report.md)
