...
|---|---|---|---|---|
| YR-143 | Exp | **전략적 YC 위치조정 없음(C0) vs 결속 PREPOSITION(C1) — 존재 가치 검증** | 🔴 | **선결 해소(2026-08-03)**: YR-147 종결 — C0/C1 모두 **R 계약**(유한 DEFER+반사실 순위손실·결속 one-shot)으로 비교. "유의 개선 없음=제거" 금지 — 신규 paired 대역에서 C0 우월 또는 사전 `δ` 내 비열등 + 검정력 충분할 때만 제거. δ·표본은 착수 사전등록 동결 · [spec](../docs/dashboard-task-specs/YR-143-no-reposition-control.md) |
