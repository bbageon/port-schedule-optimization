...
|---|---|---|---|---|
| YR-148 | Exp | **안전장치 ON 환경 C0/C1 재판정 — PREPOSITION 존재 가치 (완주 교락 제거)** | 🔴 | **선결 해소(2026-08-04)**: YR-146 대기 허가증 v2 채택(`289eb67`). 기존 체크포인트 재사용(재학습 없음)·**혼합 통계(초기화×시나리오 부트스트랩 — 시나리오 단순법 금지)**·신규 대역·δ 승계·BOTH_GUARD_FAIL 포함 4분류·개입률(상한 1%) 병행 보고 · [spec](../docs/dashboard-task-specs/YR-148-guard-on-rejudgment.md) |
