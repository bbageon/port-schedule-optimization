...
|---|---|---|---|---|
| YR-147 | RL | **WAIT-WAIT 정책 최적화 — 유한 DEFER·반사실 순위학습·희귀 교착 노출** | 🔴 | 사용자 결정(2026-08-03) 최우선 축 — 하드 마스크 없이 정책이 진행/대기를 구분하도록 최적화. **원인 수치 재현 검증 완료**: YR-145 실패판에서 회피 가능 전원 대기 결정 3회(t=17186.6/17366.6/17498.9), 마지막 결정 WAIT+WAIT 12.5055 < WAIT+SERVE 13.2208 < SERVE+WAIT 14.2435 정확 일치 · [spec](../docs/dashboard-task-specs/YR-147-wait-wait-policy-optimization.md) · [결정이력](../docs/strategy-history/2026-08-03-YR-146-WAIT-WAIT-정책최적화-우선-사용자결정.md) |
