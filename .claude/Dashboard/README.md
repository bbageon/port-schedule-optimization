...
- **★아키텍처 세대 구분 (2026-07-29, 사용자 지시)**: **YR-080 부터 2세대(현행) 아키텍처다** — 기준재 목적함수·1세대 채택 정책 기각(YR-080) → 시간계약 v2·A→O 최종 KPI(YR-089) → 판정 계약 완성(YR-106~117). **1세대(~YR-079)의 학습 성공(YR-063 퇴화 해소·YR-073-b SF 초과·YR-074 채택)은 구 지표(S→B)·구 목적 위의 결과라 2세대 증거로 이월 금지** — 인용 시 반드시 "1세대" 명기. 2세대 학습 전적은 채택 0(088·090·100·119·121·122), 2세대 성공은 규칙·계산 트랙(YR-113 창중 이송 등). [상세·인용 규칙](../docs/strategy-history/2026-07-29-아키텍처-세대구분-YR-080경계.md)
