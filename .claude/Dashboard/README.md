...
- **비용 최소화 RL (YR-025/027/028/030-b/c/012/012-b/031)**: 병목은 coverage 아닌 **순서품질**. 격차 추격 +1.28→…→**+0.083 (YR-012 Δ-net, 실정책 최강 유지)** — 해상도 세금 실증·P95 첫 개선. Oracle(YR-031)이 **상금 하한 +0.182분 실재** 증명 (혼잡일 편중). **YR-012-b (2026-07-15): 안정화(replay+target)는 진동을 줄였으나(2.32→0.91) 성능 악화 — 용의자 기각, 잔차 Δ 는 online TD 상성**. 학습절차 축 소진 — 남은 용의자 = **feature 정보 (YR-031-b 🟠 승격)** + 선택 프로토콜(YR-032). 착수는 사용자 승인 대기.
