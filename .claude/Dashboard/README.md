...
- **현재 채택 정책 구조**: 30분 중앙 공동계획기(JR_NEW)의 선택을 순위 증류·DAgger로 학습한 **2크레인 중앙 공동가치망**에 반사실 RL 미세조정(FT)과 H1 재조작 목적지 규칙을 결합한다. 실행은 중앙 resolver가 안전·물리·마감 제약을 보장한다. QMIX는 현재 채택본이 아니며, 다중 블록·다중 크레인에서 공동조합이 커질 때만 재검토한다.
