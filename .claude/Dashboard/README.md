...
- **남은 실행 순서 (정정 트랙)**: **다음 = 사용자 결정** — ① 신용 축 결합 실험(BC/차분 × state_norm — YR-059 INDEP 이득과 YR-061~065 결과의 교차 검증) ② YR-066(차분 잔여 용의자, 수확 체감) ③ QMIX 재도전 시점(신용 축 종합 후 — YR-013 2차 판정 반영). 병행 결정: YR-002 협약 트랙. 이후 YR-042 재개 → YR-014. 실측·validation 은 YR-002/009. **열린 문제·대응 종합**: [열린문제 전략](../docs/strategy-history/2026-07-16-열린문제-대응전략.md).
