...
- **P95 악화는 w_tail 로 제어 불가 (2026-07-14, YR-018 negative)**: 2프로파일×2예산 전 grid 에서 가중치 간 유의차 0 — tail_area(총량)는 개선되나 p95(극단)는 +17~+35% 악화 지속 (지표 불일치). 보호는 메커니즘 재설계(YR-029)로.
