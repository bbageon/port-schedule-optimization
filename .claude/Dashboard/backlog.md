...
|---|---|---|---|---|
| YR-013 | RL | 중앙 공동배정·QMIX 다중 YC 협조 | 🟠 | [spec](../docs/dashboard-task-specs/YR-013-exp4-multi-yc.md) · **경량 대안 소진 (2026-07-18, YR-056 negative)** — 상대 의도·경합 feature 로는 협조 격차 축소 실패 (개선 증거 0). YR-054(조정 실패 85%) + YR-056(관측 추가 무효) 로 **구조적 해법(QMIX/joint value)만 남음** — 착수 재판정 사용자 결정 대기. [재감사](../docs/YR-054-RL-재감사.md)·[YR-056 §6](../docs/YR-056-협조feature-매핑.md) |
