...
| YR-012-b | RL | Δ-net 학습 안정화 — replay buffer + target network (DQN 표준화) | 🟠 | YR-012 파생: 격차 +0.083·곡선 진동이 잔여 용의자. **YR-031 이 상금 +0.182분 실재 확인 — 회수 목표 생김**. 착수는 사용자 승인 대기 |
...
| YR-031-b | Exp | Oracle 개선 순서 패턴 분석 — beam 이 greedy 를 이긴 결정들의 공통 구조 추출 (RL feature 설계 지도) | 🟡 | YR-031 파생: 상금이 혼잡일 편중 — 어떤 상황에서 어떤 이탈이 이득인지 분석. **착수는 사용자 승인 대기** |
