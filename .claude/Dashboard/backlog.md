...
| YR-030-c | RL | Greedy 기준을 항상 보존하는 잔차 Cost-Q + 작업 후 대기열 맥락 비교 | 🟠 | `Q_total=정확한 greedy 비용+ΔQ`; ΔQ에 종료 YC 구역·남은 작업 수/총량/구성·최근접 작업 거리를 넣고 잔차-only와 paired 비교. YR-030-b 미달 뒤 2회차 실험 — [상위 전략](../docs/strategy-history/2026-07-14-YR-030-series2-baseline-pivot.md)·[선행 결과](../docs/strategy-history/2026-07-14-YR-030-b-v1final-greedy-prior-prereg.md) |
