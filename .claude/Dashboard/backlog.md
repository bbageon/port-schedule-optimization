...
| YR-031-b | Exp | Oracle 개선 순서 패턴 분석 — beam 이 greedy 를 이긴 결정들의 공통 구조 추출 (RL feature 설계 지도) | 🟠 | YR-031 파생 · **YR-012-b 로 학습절차 축 소진 — 유일한 정면 대응으로 승격 (🟡→🟠, 2026-07-15)**. 착수는 사용자 승인 대기 |
