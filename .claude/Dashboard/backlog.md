...
|---|---|---|---|---|
| YR-059 | RL | 상태 feature scale-only 정규화 + 클리핑 → QMIX 재실행 | 🟠 | **QMIX 발산 1차 용의자 대응** ([적용전략](../docs/상태정규화-보상가중치-적용전략.md) §4·6-1). 필드별 동결 norm_ref(비용 scale 기계 재사용)·결측=0 보존·SCHEMA bump. YR-013 종속, 정규화 on/off ablation |
