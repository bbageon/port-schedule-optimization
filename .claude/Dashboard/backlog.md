...
|---|---|---|---|---|
| YR-068 | RL | 차분 표적 QMIX 본 시나리오 확전 — 외부 40 대역에서 INDEP_NORM·JR 대비 재측정 | 🟠 | **YR-013c G1 승자 구성 확전 (2026-07-19)**: 진단 소형(외부 16)의 −9.41 이득이 본 시나리오(YR-059 대역, INDEP_NORM 80.51·JR 68.26)에서 재현되는지 — 규칙/JR 초과 여부가 다음 관문. rollout 비용 증가(결정 수↑) 주의 |
| YR-069 | RL | 차분 표적 QMIX 민감도 — λ_mix·창 그리드 (별도 사전등록) | ⚪ | YR-013c prereg 가 금지한 knob 탐색의 정식 경로 — YR-068 결과 보고 착수 판단 |
| YR-066 | RL | 차분 신호 잔여 용의자 — on-policy counterfactual base·창 4800s·amortized-JR 회귀 | 🟡 | **YR-065 파생 (수확 체감 구간 — 사전 기대치 낮음, 사용자 결정)**: 창 40분이 유의 개선(78.91)했으나 천장이 BC(56.25) 미만. base_policy 불일치·WAIT 앵커 변별이 잔여 후보. rollout 비용 8배 주의. **2026-07-19 갱신: 차분이 주축 승자 구성의 핵심이 되어 개량 가치 상승** |
