...
| YR-030 | RL | **계열 2 baseline 승격** — 다음 축: **대기열 맥락 주입** (잔차학습 Q=ĉ+Δ 1순위 · 맥락 feature · 함수근사) | 🟠 | YR-030-b 로 초기화(prior)·할인(γ)·입도 3축 소진 — 잔여 격차 +0.45분의 용의자는 맥락 결손 단독. **되돌릴 조건 1/2 소진** (연속 2회 미달 시 YR-012 직행 재논의). [전략](../docs/strategy-history/2026-07-14-YR-030-series2-baseline-pivot.md)·[YR-030-b 결과](../docs/strategy-history/2026-07-14-YR-030-b-v1final-greedy-prior-prereg.md) |
