...
| ID | Epic | Title | 폐기 | 사유 |
|---|---|---|---|---|
| YR-077 | Sim | 돌발(인터럽트) 강건성 축 — 고장 주입·장부 불일치·노쇼/분산 통합 arm | 2026-07-19 | **사용자 결정 (등록 당일 폐기)**: "돌발은 언제 발생할지 모르기 때문에 지금 없는 게 맞다" — 예측 불가 요소의 부재는 결함이 아니라 의도된 설계. 등록 근거였던 위험 관찰(미리 돌려보는 정책의 예측 의존)은 [YR-076 문서 §5](../docs/strategy-history/2026-07-19-NEW목적-탐색사슬-대표성격자.md)에 기록 보존 |
