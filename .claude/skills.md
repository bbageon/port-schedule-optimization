...
- [`.claude/docs/architecture/`](docs/architecture/README.md) — 구현 교차검증 기준.
  스키마·무대·결정층·비용/보상·정보경계·학습판정 6부.
  `PYTHONPATH=src python .claude/docs/architecture/verify_architecture.py` 로
  문서↔코드 자동 대조(22항목).
